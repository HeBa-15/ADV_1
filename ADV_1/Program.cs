namespace ADV_1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            ///     new Employee(){Id = 40 , Name = "Ali",   Salary = 7_000},

            /// };

            ///
            /// // int index = Helper<Employee>.LinearSearch(employees, new Employee() { Id = 40 , Name = "Ali" } , new EmployeeEqualityComparerByName());
            /// // Console.WriteLine($"Index: {index}");
            ///
            /// int index = Helper<Employee>.LinearSearch(employees, new Employee() { Id = 40, Name = "Ali" }, 
